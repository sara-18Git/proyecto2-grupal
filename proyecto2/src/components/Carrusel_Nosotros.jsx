...
const CarruselesNosotros = () => {
  ...
  const renderItems = items.map((item) => (
    <div
      key={item.id}
      className="carruseles-card-nosotros     d-flex flex-column p-1"
    >
      <Link
        ...
        style={{ color: "inherit" }}
      >
        <div className="carruseles-image-container-nosotros">
          <img
            src={item.image}
            alt={item.title}
            className="carruseles-image-nosotros w-100"
            onMouseEnter={playHoverSound}
          />
        </div>

        <div className="carruseles-content-nosotros d-flex flex-column flex-grow-1">
          <h3 className="carruseles-title-nosotros ">{item.title}</h3>
          <p className="carruseles-description-nosotros flex-grow-1 text-tarjeta-nosotros">
            {item.description}
          </p>
          <div className="carruseles-category-tag-nosotros">
            {item.category}
          </div>
          <span className="carruseles-price-nosotros mt-auto">
            {item.price}
          </span>
        </div>
      </Link>
  ...
  return (
    <div className="carruseles-container-nosotros">
      <h2 className="carruseles-heading-nosotros">Miembros Destacados</h2>
      <div className="h-100">
        <AliceCarousel
          mouseTracking
          items={renderItems}
          ...
          renderPrevButton={() => (
            <button className="carruseles-button-nosotros carruseles-button-prev-nosotros">
              <svg
          ...
          renderNextButton={() => (
            <button className="carruseles-button-nosotros carruseles-button-next-nosotros">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width="24"
