...
const CategoriaMultijugador = () => {
  ...
  const renderItems = juegos
    .filter((item) => item.genero === "Multijugador")
    .map((item) => (
  ...
  return (
    <div className="carruseles-container">
      <h2 className="carruseles-heading">Categoria Multijugador</h2>
      <div className="h-100">
        <AliceCarousel
          mouseTracking
          items={renderItems}
...
export default CategoriaMultijugador;
